...
struct OneMonthExerciseChartView: View {
    ...
    private var chartTime30: [HealthMetricValue] {
        healthKitVM.exerciseTime30Days.sorted { lhs, rhs in
            lhs.date > rhs.date
        }
    }
    ...
    var selectedHealthValue: HealthMetricValue? {
        ...
        return healthKitVM.exerciseTime30Days.first { Calendar.current.isDate(rawSelectedDate, inSameDayAs: $0.date) }
    }
